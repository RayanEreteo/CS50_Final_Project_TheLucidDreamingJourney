...
Finally, my quiz page will test the user's knowledge about lucid dreaming, all the questions must be in the questions.json file; once every answer is submitted, it will redirect to the "quizresult" route and show the score.
